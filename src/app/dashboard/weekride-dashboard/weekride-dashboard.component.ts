...
import { BikeService, RideWeek } from '../../bike/bike.service';
...
@Component({
  selector: 'app-weekride-dashboard',
  standalone: true,
  providers: [BikeService],
  imports: [NgApexchartsModule, HttpClientModule],
  templateUrl: './weekride-dashboard.component.html',
  styleUrl: './weekride-dashboard.component.scss'
})
export class WeekrideDashboardComponent {
  ...
  ngOnInit(): void {
    this.bikeService.getRideWeekTotal().subscribe(data => {
      this.weekRides = data;
      this.initChartData();
    });
  }
  ...
  public initChartData(): void {
    ...
    this.weekRides.sort((a, b) => parseInt(b.week) - parseInt(a.week));

    let lastWeek = this.weekRides[0].week;
    let firstWeek = this.weekRides[this.weekRides.length - 1].week;
